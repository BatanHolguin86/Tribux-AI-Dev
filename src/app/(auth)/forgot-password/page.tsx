...
export default function ForgotPasswordPage() {
  ...
  if (success) {
    return (
      <div className="text-center">
        ...
        <h2 className="text-xl font-display font-bold text-gray-900 dark:text-gray-100">Email enviado</h2>
  ...
  return (
    <>
      <div className="mb-8">
        <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-gray-100">Recuperar contrasena</h2>
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
