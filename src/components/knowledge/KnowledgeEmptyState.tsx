  ...
  return (
    <div className="flex h-[var(--content-height)] items-center justify-center">
      <div className="mx-auto max-w-md rounded-2xl border border-dashed border-gray-300 bg-gray-50/50 px-8 py-12 text-center dark:border-gray-600 dark:bg-gray-900/40">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-surface text-3xl dark:bg-brand-primary/30">
          📚
        </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          <button
            onClick={handleSeed}
            disabled={seeding}
            className="flex items-center gap-2 rounded-lg bg-brand-primary px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-brand-navy disabled:opacity-50"
          >
            {seeding ? (
              <>
