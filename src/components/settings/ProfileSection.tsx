        ...
        <div>
          ...
          <div className="mt-1 flex gap-2">
            <input
              ...
              className="block w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm shadow-sm dark:shadow-gray-900/20 focus:border-brand-teal focus:outline-none focus:ring-1 focus:ring-[#0EA5A3] dark:bg-gray-800 dark:text-gray-100"
            />
            <button
              onClick={handleSave}
              disabled={saving || name === fullName}
              className="rounded-md bg-brand-primary px-3 py-2 text-sm font-medium text-white hover:bg-brand-navy disabled:opacity-50"
            >
              {saving ? '...' : 'Guardar'}
            </button>
          </div>
