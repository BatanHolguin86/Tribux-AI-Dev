...
function GitHubConfigForm({
  ...
  return (
    <div className="mt-3 rounded-lg border border-violet-200 bg-violet-50/50 p-3 dark:border-violet-700/40 dark:bg-violet-900/10">
      ...
      <input
        ...
        className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs text-gray-800 placeholder-gray-400 focus:border-violet-400 focus:outline-none focus:ring-1 focus:ring-violet-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
      />
...
function SupabaseConfigForm({
  ...
  return (
    <div className="mt-3 rounded-lg border border-violet-200 bg-violet-50/50 p-3 dark:border-violet-700/40 dark:bg-violet-900/10 space-y-2">
      <div>
    ...
    <div className="mt-3 rounded-lg border border-violet-200 bg-violet-50/50 p-3 dark:border-violet-700/40 dark:bg-violet-900/10">
      ...
      {status === 'error' && (
        <div>
          ...
          <button onClick={() => setStatus('idle')} className="mt-1.5 text-xs text-violet-600 hover:underline">
            Reintentar
          </button>
        </div>
      )}
  ...
  return (
    <div className="mt-3 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800/50">
      <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">
        ...
        No es configurable desde la UI de AI Squad.
      </p>
      <div className="flex gap-2">
        {docsUrl && (
          <a
    ...
    <div className={`rounded-xl border bg-white dark:bg-gray-900 transition-all ${
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          {isActionable && (
            <span className={`text-[11px] font-medium transition-colors ${expanded ? 'text-violet-600 dark:text-violet-400' : 'text-rose-500 dark:text-rose-400'}`}>
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            ...
            en producción. <span className="text-violet-600 dark:text-violet-400">Haz clic en las cards rojas para configurar.</span>
          </p>
        </div>
