...
export function ApplyToRepoButton({ content, projectId, repoUrl }: ApplyToRepoButtonProps) {
  ...
  if (!expanded) {
    return (
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-violet-50 px-3 py-1.5 text-xs font-medium text-violet-700 ring-1 ring-violet-200 transition-colors hover:bg-violet-100 dark:bg-violet-900/20 dark:text-violet-300 dark:ring-violet-800/50"
      >
        <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="mt-2 rounded-lg border border-violet-200 bg-violet-50/50 p-3 dark:border-violet-800/50 dark:bg-violet-900/10">
      <div className="mb-2 text-xs font-medium text-violet-700 dark:text-violet-300">
        Archivos a aplicar:
      </div>
      ...
      <input
        ...
        className="mb-2 w-full rounded-md border border-gray-300 px-2.5 py-1.5 text-xs dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500"
      />
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="rounded-md bg-violet-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-violet-700 disabled:opacity-50"
        >
