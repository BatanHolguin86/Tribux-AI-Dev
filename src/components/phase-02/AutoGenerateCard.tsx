...
export function AutoGenerateCard({ projectId, missingCount }: AutoGenerateCardProps) {
  ...
  if (done) {
    return (
      <div className="mb-6 rounded-xl border-2 border-[#10B981] bg-[#10B981]/10 p-6 text-center">
        ...
        <h3 className="font-display text-lg font-display font-bold text-brand-primary dark:text-white">
  ...
  return (
    <div className="mb-6 rounded-xl border-2 border-brand-teal/30 bg-gradient-to-br from-white to-[#E8F4F8]/50 p-6 dark:from-[#0F2B46] dark:to-[#0A1F33]">
        ...
        <div className="flex-1">
          ...
          {generating && (
            <div className="mt-4">
              ...
              <div className="mt-1.5 h-2 overflow-hidden rounded-full bg-[#E2E8F0] dark:bg-brand-navy">
                <div
              ...
              <div className="mt-2 flex items-center gap-2">
                <svg className="h-4 w-4 animate-spin text-brand-teal" fill="none" viewBox="0 0 24 24">
          ...
          {!generating && (
            <button
              ...
              className="mt-4 rounded-lg bg-brand-teal px-6 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#0C8C8A]"
            >
