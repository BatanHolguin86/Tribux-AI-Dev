...
export function ActionStreamingPanel({
  ...
  return (
    <div className="rounded-lg border-2 border-brand-teal/30 dark:border-brand-primary bg-white dark:bg-gray-900 overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-2">
        <div className="flex items-center gap-2">
          ...
          {isStreaming && (
            <span className="flex items-center gap-1 text-xs text-brand-primary dark:text-brand-teal">
