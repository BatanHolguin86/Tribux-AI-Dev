        ...
        <div className="mt-4 flex items-center justify-between border-t border-gray-100 dark:border-gray-800 pt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="rounded-lg bg-gradient-to-r from-[#0F2B46] to-[#0EA5A3] px-3.5 py-1.5 text-xs font-semibold text-white shadow-sm transition-all hover:shadow-md hover:brightness-110"
            >
              Continuar
            </Link>
          </div>
