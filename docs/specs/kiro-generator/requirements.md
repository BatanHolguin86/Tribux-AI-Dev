...
- [ ] La lista de features se persiste en `phase_sections` con `section = feature_{nombre}`
...
- Validacion automatica de coherencia entre specs de diferentes features — v2.0
