...
1. **Platform-level tokens** — AI Squad holds its own GitHub org, Supabase org, and Vercel team. Users don't configure anything.
2. **One Supabase project per AI Squad project** — isolated databases, not shared schemas.
