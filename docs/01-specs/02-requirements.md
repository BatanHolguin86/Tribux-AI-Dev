...
**REQ-031** WHEN a discovery section is completed, the system shall auto-generate the corresponding markdown document in the project's /docs/00-discovery/ directory.
